...
export class ProductService {
  ...
  private products(): Observable<Product[]> {
    ...
    return this.httpClient.get<Product[]>('https://localhost:7095/api/Product/GetProducts');

  }

  // private productsFromApi(): Observable<Product[]> {
  //   return this.httpClient.get<Product[]>('assets/images/products/cocount-cup.jpg');
  // }
